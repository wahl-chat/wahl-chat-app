...
from ingestion.speech_dedup import lookback_floor as _lookback_floor

logger = logging.getLogger(__name__)

# MdB-Stammdaten XML, resolved relative to ingestion/. connector.py is 4 levels
# deep: ingestion/src/ingestion/connectors/openparliament_tv/connector.py → parents[4] = ingestion/.
