...
``ingestion/`` (see AGENTS.md for why the two are independent).

Found by walking up from this module, so it resolves in the repo and in the image
alike; CORPUS_CONTRACT_PATH overrides. Values needing static types (the ``Literal`` unions in ``retrieve.py``)
