...
class TestDipSpeechKeyAndSource:
    ...
    def test_op_dip_parity_via_mapper(self) -> None:
        ...
        """
        from ingestion.speech_key import make_speech_key
...
class TestNormalizePartyCsu:
    ...
    def test_is_known_party_csu(self) -> None:
        ...
        from ingestion.connectors.bundestag_speeches.utils import is_known_party
...
def test_bulk_stamps_external_id_from_date() -> None:
    ...
    from ingestion.connectors.bundestag_speeches.bulk import ingest
    import json
    import tempfile
...
def test_dip_client_pages_stops_at_max_pages() -> None:
    ...
    from ingestion.connectors.bundestag_speeches.client import DipClient
    from ingestion.connectors.bundestag_speeches.constants import _MAX_PAGES
