...
from ingestion.connectors.bundestag_speeches.client import DipClient, fetch_text
from ingestion.connectors.bundestag_speeches.constants import MDB_STAMMDATEN_FILE
from ingestion.connectors.bundestag_speeches.mappers import corpus as corpus_mapper
from ingestion.connectors.bundestag_speeches.mdb import (
    ensure_mdb_lookup,
    mdb_party_for_speech,
    mdb_record_for_speaker_name,
)
from ingestion.connectors.bundestag_speeches.parser import parse_speeches_from_xml
from ingestion.connectors.bundestag_speeches.utils import normalize_party
...
# Resolved relative to the ingestion/ directory (connector.py is 4 levels deep:
# ingestion/src/ingestion/connectors/bundestag_speeches/connector.py → parents[4] = ingestion/)
