...
def _abgeordnetenwatch_votes_factory() -> BaseConnector:
    ...
    from ingestion.connectors.abgeordnetenwatch.connector import (
...
def _manifestos_factory() -> BaseConnector:
    ...
    """
    from ingestion.connectors.manifestos.connector import ManifestoConnector  # noqa: PLC0415
...
def _openparliament_tv_factory() -> BaseConnector:
    ...
    """
    from ingestion.connectors.openparliament_tv.connector import (
