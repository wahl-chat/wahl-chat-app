...
"""
Unit tests for ManifestoConnector (ingestion/src/ingestion/connectors/manifestos/connector.py).
...
from ingestion.connectors.manifestos import connector as conn_mod
from ingestion.connectors.manifestos.connector import ManifestoConnector
