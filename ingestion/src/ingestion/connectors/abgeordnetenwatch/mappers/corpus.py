...
from ingestion.ids import make_chunk_key
...
from ingestion.connectors.abgeordnetenwatch.mappers.stance import (
    aggregate_fraction_tallies,
    derive_stance,
)
from ingestion.connectors.abgeordnetenwatch.topic_taxonomy_config import (
...
# state/regional layer live in ingestion/src/ingestion/party_slugs.py (single source of
