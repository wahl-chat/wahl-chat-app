...
export default function TutorialPage() {
  ...
  const form = useForm<TutorialAckFormValues>({
    resolver: zodResolver(tutorialAckSchema),
    defaultValues: { understood: false },
  });
  ...
  const handleContinue = form.handleSubmit(async () => {
