...
CITATION_DIRECTIVE = """    - Zitierstil — KRITISCH, BEFOLGE DIESE REGEL STRIKT:
        ...
        - **Komma-Listen mehrerer Forderungen sind verboten — schon ab 2 Forderungen.** Sätze wie „<Partei> fordert A, B und C" oder „A und B" mit zwei Quellen brechen auf: jede Forderung wird ihr eigener Satz oder Listenpunkt mit ihrer eigenen ID. Das gilt auch in „Außerdem will die Partei…"- oder „Was das praktisch heißt…"-Passagen.
