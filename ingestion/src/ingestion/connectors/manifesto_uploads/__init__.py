...
Storage bucket as
``public/{context_id}/{wahlprogramme|parteidokumente}/{party_id}/{name}_{YYYY-MM-DD}.pdf``
and ingested into the same ``party_manifesto`` corpus with ``source="upload"``. The
class folder decides whether an Abgeordnetenwatch copy may retire the document.
