...
class QuizQuestion(BaseModel):
    ...
    question_type: Literal["A", "B", "C"] | None = Field(
        default=None,
        description=(
            "Question type for evaluation analysis. A = 'Welche Partei …?', "
            "B = 'Wie steht X zu …?', C = 'Welche Aussage trifft auf X zu?'."
        ),
    )
    ...
    partial_credit_indices: list[int] = Field(
        ...
        description=(
            ...
            "Typically the individual-party options on a Type A overlap "
            "question whose correct answer is 'Mehrere der genannten Parteien'."
        ),
    )
