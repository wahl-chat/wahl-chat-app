...
export const config = {
  matcher: [
    // '/' is deliberately absent: it serves the landing page directly. Routing
    // it by IP made crawlers and German visitors land on different elections,
    // and pointed every inbound link at a redirect instead of a page.
    '/chat/:path*',
    '/session/:path*',
    '/swiper/:path*',
    '/share',
