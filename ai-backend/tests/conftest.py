...
_FAKE_ZERO_VECTOR = [0.0] * 3072  # matches EMBEDDING_DIM
...
def temp_qdrant_collection() -> "Generator[tuple, None, None]":
    ...
    Mirrors the temp_collection fixture in ingestion/tests/test_qdrant_schema.py.
    ...
    try:
        ...
        from src.corpus import EMBEDDING_DIM
