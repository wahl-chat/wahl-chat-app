...
"""
Unit tests for ingestion/src/ingestion/connectors/manifestos/mappers/corpus.py.
...
class TestRegionForPeriod:
    ...
    def test_unknown_label_quarantine_warns(
        ...
        from ingestion.connectors.manifestos.mappers import corpus as corpus_mod
...
class TestSlugMapParity:
    ...
    lives in one module (ingestion/src/ingestion/party_slugs.py); these tests guard that
    ...
    def test_canonical_core_is_shared_verbatim(self) -> None:
        ...
        from ingestion.connectors.abgeordnetenwatch.mappers.corpus import (
        ...
        from ingestion.party_slugs import CANONICAL_PARTY_SLUGS
    ...
    def test_votes_and_manifestos_share_the_state_party_layer(self) -> None:
        ...
        from ingestion.party_slugs import STATE_PARTY_SLUGS
...
class TestManifestoMeta:
    def test_extra_fields_forbidden(self) -> None:
        ...
        from ingestion.connectors.manifestos.mappers.corpus import ManifestoMeta
