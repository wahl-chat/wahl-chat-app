# Leaf Content Generator Agent

## Purpose

Generates the structured 4-section content for a leaf subtopic with streaming support. This is the primary content shown when a user navigates to a subtopic.
...
**Input:** `LeafContentGeneratorInput`
