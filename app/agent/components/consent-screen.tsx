            ...
            <div className="w-full max-w-2xl space-y-6">
                ...
                <div className="text-center">
                    ...
                    <p className="mt-2 text-muted-foreground">
                        Ihr persönlicher Begleiter zur politischen Meinungsbildung
                    </p>
                </div>
                ...
                <Card className="border-blue-200 bg-blue-50/50 dark:border-blue-900 dark:bg-blue-950/30">
                    ...
                    <CardContent className="space-y-4 text-sm text-blue-900/80 dark:text-blue-100/80">
                        <p>
                            Mit der Teilnahme an dieser Forschungsstudie tragen Sie Ihren Teil
                        ...
                        <p>
                            ...
                            Wahl Agent wird Sie in dem folgenden Gespräch dabei unterstützen,
                            Ihre Sorgen zu schildern und Ihre persönliche Ideallösung zu
                            formulieren, um die Partei zu finden, die am besten zu Ihnen
                            passt.
                        </p>
                    </CardContent>
                </Card>
                    ...
                    <CardContent>
                        <ul className="space-y-2 text-sm text-muted-foreground">
                            ...
                            <li className="flex items-start gap-2">
                                <span className="mt-1.5 size-1.5 shrink-0 rounded-full bg-muted-foreground" />
                                <span>
                                    Ihre Antworten und Perspektiven zu politischen Themen werden
                                    aufgezeichnet
                                </span>
                            </li>
                        </ul>
                    ...
                    <CardContent>
                        <ul className="space-y-2 text-sm text-muted-foreground">
                            ...
                            <li className="flex items-start gap-2">
                                <Lock className="mt-0.5 size-4 shrink-0 text-green-600" />
                                <span>
                                    Ihre Informationen werden ausschließlich für wissenschaftliche
                ...
                <p className="text-center text-sm text-muted-foreground">
                    Durch Klicken auf &quot;Ich stimme zu&quot; bestätigen Sie, dass Sie
                    damit einverstanden sind, an dieser Forschungsstudie teilzunehmen.
                </p>
