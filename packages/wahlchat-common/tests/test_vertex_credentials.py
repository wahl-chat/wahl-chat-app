...
"""
Unit tests for the Vertex AI credential resolver (packages/wahlchat-common/src/wahlchat_common/vertex_credentials.py).
...
_LOGGER_NAME = "wahlchat_common.vertex_credentials"
